...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('timestampmodel_ptr', models.OneToOneField(parent_link=True, auto_created=True, primary_key=True, serialize=False, to='herencia.TimeStampModel')),
                ('portada', models.ImageField(upload_to=b'portada', null=True, verbose_name=b'Portada (Imagen)', blank=True)),
                ('titulo', models.CharField(max_length=400, verbose_name=b'Titulo')),
